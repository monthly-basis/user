...
class ResetPasswordTest extends TableTestCase
{
    ...
    public function test_updateSetUsedToUtcTimestampWhereUserIdAndCode()
    {
        $result = $this->resetPasswordTable->updateSetUsedToUtcTimestampWhereUserIdAndCode(
            12345,
            'the-code',
        );
        $this->assertSame(
